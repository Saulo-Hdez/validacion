        ...
        <div class="row clearfix">
            <div class="col-12">
                <div class="navbar-logo">
                    ...
                    <a class="navbar-brand" href="{{route('home')}}"><img src="{{ asset('assets/images/logo.svg') }}" width="30" alt="InfiniO"><span class="m-l-10">EXPOCYTEQ</span></a>
                </div>
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown profile">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <div class="user-info">
                                    <h6 class="user-name m-b-0">{{ Auth::user()->nombre }} {{ Auth::user()->apellidos }}</h6>
                                    <p class="user-position">Disponible</p>
                            ...
                            <li><a href="#"><i class="icon-user m-r-10"></i> <span>Mi Perfil</span></a></li>
                            <li><a href="{{ route('logout') }}" onclick="event.preventDefault();
                              document.getElementById('logout-form').submit();">
                              <i class="icon-power m-r-10"></i><span>Cerrar Sesión</span>
                              </a>
